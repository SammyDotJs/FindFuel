  ...
  return (
    <TouchableWithoutFeedback onPress={handleBodyPress}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Modal isVisible={modalVisible} onBackdropPress={toggleModal} style={styles.modal} backdropOpacity={0} animationIn="slideInUp"
          animationOut="slideOutDown" animationType="slideInDown">
          <View style={styles.modalContent}>
            {selectedStation && (
              <View style={ms.modalContainer}>
                <View style={ms.fillingStationInfo}>
