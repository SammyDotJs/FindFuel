  ...
  return (
    <TouchableWithoutFeedback onPress={handleBodyPress}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Modal isVisible={modalVisible} onBackdropPress={toggleModal} style={styles.modal} backdropOpacity={0} animationIn="zoomIn"
          animationOut="zoomOut" animationType="fade">
